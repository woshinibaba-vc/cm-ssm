    ...
    */
    ...
    function build_emps_table(result) {
        ...
        $.each(emps, function (index, item) {
            ...
            var departmentTd = $("<td></td>").append(item.pstatus);
            var uphone = $("<td></td>").append(item.chargeitem.cname);
            var ustarttime = $("<td></td>").append(item.user.uname);
