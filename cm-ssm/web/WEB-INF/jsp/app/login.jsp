				...
				<div class="auth-box ">
						...
						<div class="content" style="width: 98%">
							<form class="form-auth-small" action="${basePath}/user/login" method="post">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="uname" id="signin-email" placeholder="您的用户名..." required>
								</div>
								<div class="form-group">
									<label for="signin-password" class="control-label sr-only">密码</label>
									<input type="password" class="form-control" name="upassword" id="signin-password" placeholder="您的密码..." required>
								</div>
								<div class="form-group">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">欢迎来到XX小区管理系统登录界面</h1>
						</div>
					</div>
